...
é 2, ou seja, são 2 fatores que tem eigen values > 1. Os valores desses fatores podem ser
vistos na tabela abaixo, no entanto, de acordo com o Scree plot e a % de captura
de variância do primeiro fator (92.85%), e por isso será somente ele o fator utilizado
para a criação deste ranking.
